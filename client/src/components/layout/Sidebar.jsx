  ...
  return (
    <>
      ...
      {isAdmin || isSuperAdmin ? (
          <>
          <div className={isCollapsed ? sidebar.containerExpanded : sidebar.container}>
          <div className="pt-6">
          <SidebarLogo/>
            ...
            className='aspect-square w-10 bg-[#314095] border border-primary-active rounded-full flex items-center justify-center z-10 absolute top-3 right-0 translate-x-1/2 -translate-y-0 cursor-pointer'>
          ...
          (
            ...
            <div className={isCollapsed ? sidebar.RSOcontainerExpanded : sidebar.RSOcontainer}>
            <div className="pt-6">
            <SidebarLogo
            logoStyle="dark"
            />
            ...
            <div className={classNames(sidebar.sidebarContainer, isCollapsed && 'hidden')}>

                <div 
                onClick={() => collapseSidebar()}
                className='aspect-square w-10 bg-white border border-mid-gray rounded-full flex items-center justify-center z-10 absolute top-3 right-0 translate-x-1/2 -translate-y-0 cursor-pointer'>
