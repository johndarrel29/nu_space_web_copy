...
// repRSODocumentRoute
// if docutmentType is activity, then the route is /:activityId/documents
// if documentType is general, then the route is /submitDocument
    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        {documentType === "activity" ? (
          <h2 className="text-2xl font-bold text-[#312895]">Upload Activity Documents</h2>
        ) : documentType === "general" ? (
          <h2 className="text-2xl font-bold text-[#312895]">Upload General Documents</h2>
        ) : (
