...
// the selected item from dropdownsearch returns N/A when saving edit
  ...
  const handleConfirm = () => {
    try {
      ...
      if (mode === "edit") {
        ...
        if (selectedRole === "rso_representative" &&
          (!selectedCategory || selectedCategory === "N/A" || selectedCategory === "")) {
      ...
      setLocalError("An error occurred while processing your request. Please try again.");
    }
