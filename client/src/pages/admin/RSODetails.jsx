          ...
          <div className='flex flex-col justify-start mt-3 sm:mt-0 sm:ml-4 w-full'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-2'>
              ...
              <div 
                ...
                className='px-4 py-1 bg-white text-[#312895] rounded-full text-sm border border-[#312895] hover:bg-[#312895] hover:text-white group cursor-pointer w-fit'
              >
                <div className='flex items-center gap-2 cursor-pointer'>
                  <svg xmlns="http://www.w3.org/2000/svg" className='size-3 fill-[#312895] group-hover:fill-white' viewBox="0 0 512 512">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="text-sm font-medium py-1">
                      <div className='flex items-center gap-2 hover:underline cursor-pointer text-[#312895]'>
                  ...
                  <tr>
                    ...
                    <td className="text-sm font-medium text-[#312895] py-1">
