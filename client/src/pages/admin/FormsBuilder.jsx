...
export default function FormsBuilder() {
  ...
  return (
    <div className="flex flex-col w-full">
      <div className="fixed top-0 left-0 right-0 bg-white border border-mid-gray h-16 p-4 z-50 flex items-center justify-between">
        {/* Left side with back button */}
          <Button 
          style={"secondary"} onClick={() => navigate(-1)}>
            <div className='flex items-center gap-2'>
                <svg xmlns="http://www.w3.org/2000/svg" className="size-5" viewBox="0 0 448 512">
        ...
        {/* Right side with existing content */}
            ...
            <div 
              ...
              {dropdownOpen && (
                <div className="absolute top-6 right-0 mt-2 w-64 bg-white rounded-md shadow-lg py-1 z-40 pl-2 pr-2">
                  <div className="w-full flex items-start gap-2 py-2 text-sm rounded mb-2">
                    <div className="flex items-center gap-2">
                      {/* profile picture */}
                      {isStudentRSO ? (
