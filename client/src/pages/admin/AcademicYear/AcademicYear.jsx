            ...
            <div className="flex flex-col items-center justify-start w-full ">
                <div className="flex flex-col w-[800px] justify-center mb-4">
                    ...
                    <div className="flex flex-col items-center justify-center w-full">
                        ...
                        <h2 className="text-3xl font-bold my-8">{activeYear ? `${activeYear.startYear}-${activeYear.endYear}` : 'No Academic Year set.'}</h2>
                    ...
                    <div className="w-full rounded bg-light-gray border border-mid-gray p-4 flex justify-evenly items-center relative">
                        <table>
                            <tr>
                                ...
                                <td className="p-2 font-bold">{activeYear ? (FormatDate(activeYear.startDate)) : 'No data'}</td>
                            </tr>
                            <tr>
                                <td className="p-2 text-gray-800 text-sm text-end">End</td>
                                <td className="p-2 font-bold">{activeYear ? (FormatDate(activeYear.endDate)) : 'No data'}</td>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                ...
                                <td className="p-2 flex items-center gap-2 font-bold">
                                    <div className={`aspect-square w-4 h-4 rounded-full ${activeYear && activeYear.isActive ? 'bg-success' : 'bg-error'}`}></div>
                                    {activeYear ? (activeYear.isActive ? "Active" : "Inactive") : "No data"}
                                </td>
                            </tr>
                            <tr>
                                <td className="p-2 text-gray-800 text-sm text-end">Upcoming</td>
                                <td className="p-2 font-bold flex items-center gap-2">
                                    <div className={`aspect-square w-4 h-4 rounded-full ${activeYear && activeYear.isUpcoming ? 'bg-success' : 'bg-error'}`}></div>
                                    {activeYear ? (activeYear.isUpcoming ? "Upcoming" : "No Upcoming") : "No data"}
                                </td>
                            </tr>
                        </table>
                            ...
                            <div className="fixed inset-0 flex items-center justify-center z-50">
                                <div className="bg-white rounded-lg p-6 w-1/3 shadow-xl border border-mid-gray">
                                    <div className='flex justify-between items-center mb-4'>
                                        <h2 className="text-lg font-semibold text-[#312895]">
                                            {mode === 'edit'
                                                ? 'Edit Academic Year'
                                                : mode === 'create'
                                                    ? 'Create New Academic Year'
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="p-2 font-bold">
                                                            {mode === 'view' ? (
                                                                FormatDate(academicYearData.startDate)
                                                            ) : (
                                                                <input
                                                                    type="date"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="p-2 font-bold">
                                                            {mode === 'view' ? (
                                                                FormatDate(academicYearData.endDate)
                                                            ) : (
                                                                <input
                                                                    type="date"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="p-2 flex items-center gap-2 font-bold">
                                                            {mode === 'view' ? (
                                                                <>
                                                                    <div className={`aspect-square w-4 h-4 rounded-full ${academicYearData.isActive ? 'bg-success' : 'bg-error'}`}></div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="p-2 flex items-center gap-2 font-bold">
                                                            {mode === 'view' ? (
                                                                <>
                                                                    <div className={`aspect-square w-4 h-4 rounded-full ${academicYearData.isUpcoming ? 'bg-success' : 'bg-error'}`}></div>
                                    ...
                                    <div className={`flex mt-6 gap-2 ${mode === 'view' ? 'justify-end' : mode === 'edit' ? 'justify-between' : 'justify-end'}`}>
                                        {/* Delete Button - Only show in edit mode */}
                                        {mode === 'edit' && (
                                            <div
                                                className='aspect-square h-12 w-12 hover:bg-gray-200 rounded-full flex items-center justify-center cursor-pointer'
                                                onClick={handleOpenDeleteModal}
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" className='fill-gray-600 size-6' viewBox="0 0 640 640"><path d="M232.7 69.9L224 96L128 96C110.3 96 96 110.3 96 128C96 145.7 110.3 160 128 160L512 160C529.7 160 544 145.7 544 128C544 110.3 529.7 96 512 96L416 96L407.3 69.9C402.9 56.8 390.7 48 376.9 48L263.1 48C249.3 48 237.1 56.8 232.7 69.9zM512 208L128 208L149.1 531.1C150.7 556.4 171.7 576 197 576L443 576C468.3 576 489.3 556.4 490.9 531.1L512 208z" /></svg>
                                            </div>
                                        )}
                                    ...
                                    <div className='space-y-4'>
                                        <div className="w-full p-4 text-center">
                                            ...
                                            <p className="text-gray-600">
                                                ...
                                                <span className="font-bold"> {activeYear ? `${activeYear.startYear}-${activeYear.endYear}` : ''}</span>.
