...
import { useCoordinatorDocuments, useAVPDocuments, useDirectorDocuments } from '../../../hooks';
import { useState, useEffect } from 'react';
import Switch from '@mui/material/Switch';
import { toast } from 'react-toastify';

// TODO: Connect the approve fetch to form
                ...
                >
                    <div className="flex gap-3 sm:gap-4 items-center w-full">
                        ...
                        <div className="flex flex-col max-w-full overflow-hidden">
                            ...
                            <div className="flex gap-2 items-center">
                                <h2 className="text-gray-600 text-xs sm:text-sm truncate max-w-[150px] sm:max-w-[200px]">
                                    {documentType ?
                                        documentType.charAt(0).toUpperCase() + documentType.slice(1) :
                                        "Unknown Type"}
                                </h2>
                                <div className="aspect-square h-1.5 sm:h-2 w-1.5 sm:w-2 bg-gray-400 rounded-full flex-shrink-0" />
                                <h2 className="text-gray-600 text-xs sm:text-sm">
                                    {documentSize || "Unknown Size"} MB
                                </h2>
                            </div>
                        </div>
                    </div>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="fill-gray-600 size-5 sm:size-6 mt-2 sm:mt-0 self-end sm:self-center"
                        viewBox="0 0 640 640"
                    >
                    ...
                    <tbody>
                        <tr>
                            <td className="text-gray-600 flex items-center gap-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="fill-gray-600 size-4"
                                    viewBox="0 0 640 640"
                                >
